...
exports.reload = function (name) {
    templates[name] = exports.Template(name);
};
...
exports.reloadDocument = function (name) {
    var fileName = "thatsallfolks/" + name; 
...
exports.Template = function (name) {
    ...
    UTIL.update(template, {
        "name": name,
        "documents": exports.deepBases(document).map(function (name) {
            return exports.loadDocument(name);
        })
    });
    return template;
};
...
exports.deepBases = function (document, visited) {
    ...
    document.bases.forEach(function (base) {
        var document = exports.loadDocument(base);
        bases.unshift.apply(bases, exports.deepBases(document, visited));
    });
    return bases;
};
